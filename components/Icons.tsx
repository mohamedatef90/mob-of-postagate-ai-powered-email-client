...
export const CheckVIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 12.75 6 6 9-13.5" />
  </svg>
);

export const CheckThinIcon: React.FC<IconProps> = (props) => (
...
export const CameraIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.21 2.21 0 0 1 5.22 4.027l.982-1.397A2.25 2.25 0 0 1 8.25 2h7.5a2.25 2.25 0 0 1 2.043.93l.982 1.397a2.21 2.21 0 0 1-1.607 2.148L19.5 6.5l-1.5 9.75a2.25 2.25 0 0 1-2.244 2.077H8.244a2.25 2.25 0 0 1-2.244-2.077L4.5 6.5l1.043-.325Z" />
...
export const HeadphonesIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.114 5.636a9 9 0 0 1 0 12.728M4.886 5.636c-3.308 3.308-3.308 8.682 0 12.728M12 21a9 9 0 0 0 9-9V9a9 9 0 0 0-9-9c-2.39 0-4.63.93-6.364 2.636A8.965 8.965 0 0 0 3 9v3a9 9 0 0 0 9 9Z" />
    </svg>
);

export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.952a4.5 4.5 0 0 1 6.364 0M12 15.75a4.5 4.5 0 0 1-6.364 0M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 6.72a9.094 9.094 0 0 0-3.741-.479m0 0a4.5 4.5 0 0 1-6.364 0m6.364 0a9.094 9.094 0 0 1-3.741.479M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>
);
...
export const PinIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0-5.25-4.25-9.5-9.5-9.5S.5 6.75.5 12c0 4.25 2.75 8.125 6.75 9.25L12 23l4.75-1.75c4-1.125 6.75-5 6.75-9.25Z" />
    </svg>
);
...
export const MoveIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12h.01M12 6h.01M12 18h.01M7.5 12h.01M16.5 12h.01" />
    </svg>
);
...
export const EnvelopeXMarkIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 9v.906a2.25 2.25 0 0 1-1.183 1.981l-6.478 3.488M2.25 9v.906a2.25 2.25 0 0 0 1.183 1.981l6.478 3.488m8.839 2.51-4.66-2.51m0 0-1.023-.55a2.364 2.364 0 0 0-2.131 0l-1.023.55m-4.661-2.51L3 12.75V9m18 0-8.625-4.625a2.25 2.25 0 0 0-2.75 0L3 9m18 0-9 4.875M3 9l9 4.875" />
    </svg>
);
